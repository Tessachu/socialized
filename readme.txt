...
Yes! If you leave the "Campaign Term" blank in the metabox on your page, but you've typed something into the "focus keyphrase" in Yoast SEO's metabox, it will default to that value.
...
If you're using canonical URLs, it won't have any effect. Since the vanity URLs redirect using 301 permanent redirects, the "page rank" is transferred, preserving your SEO value.
